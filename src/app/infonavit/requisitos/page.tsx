    ...
    <>
      ...
      <Section spacing="xl" className="pt-32 relative overflow-hidden">
        ...
        <Container width="md" className="text-center relative">
          <Badge>Checklist 2026</Badge>
          <Heading as={1} size="3xl" className="mt-6">
            Requisitos <span className="text-accent">INFONAVIT</span>
          </Heading>
          <p className="text-text-muted mt-4 text-base leading-relaxed max-w-lg mx-auto">
            Documentos agrupados por categoría. Los marcados como{" "}
            <span className="text-accent font-semibold">obligatorios</span> son indispensables;
            los opcionales sólo si aplican a tu situación.
          </p>
        </Container>
      </Section>
                ...
                <Card key={cat.titulo} padding="lg">
                  <div className="flex items-start justify-between gap-4 mb-4">
                    <div>
                      ...
                      <Heading as={2} size="md">{cat.titulo}</Heading>
      ...
      <Section spacing="lg" tone="muted">
        <Container width="md">
          <div className="text-center mb-10">
            <Heading as={2} size="2xl">Pasos del trámite</Heading>
            <p className="text-text-muted mt-3 text-sm">
              De los 100 puntos a las llaves: la ruta completa.
            </p>
          </div>
      ...
      <Section spacing="xl" className="text-center">
        <Container width="sm">
          ...
          <p className="text-text-muted mb-10 leading-relaxed">
            Carolina te orienta en la preparación de tu expediente —sin costo— y te dice qué
            documentos aplican para tu caso.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button href="https://calendly.com/sensabrokers/consulta" external size="lg">
